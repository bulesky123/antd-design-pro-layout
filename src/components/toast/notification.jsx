...
export default class Notification extends React.Component {
  ...
  getNoticeDOM = () => {
    ...
    return notices.map(notice => <Notice key={notice.key} {...notice} />)
  }
      ...
      <div className={styles[`${prefixCls}-container`]}>
        {maskDOM}
        {
          this.props.isLoading ?
            <div className={cls(styles[`${prefixCls}-box`], styles[`${prefixCls}-loading-box`])}>
              { noticesDOM }
            </div>
            :
  ...
  function ref(notification) {
    ...
    callback({
      ...
      destroy() {
        ...
        div && div.parentNode && div.parentNode.removeChild(div)      // eslint-disable-line
      },
    })
  }
